...
public class EnemyMovementSouth extends DefaultTask implements PriorityTask {
  ...
  public EnemyMovementSouth(AtlantisTerrainFactory terrainFactory, TaskRunner owner) {
