...
public class UnitMovementTask extends DefaultTask{
    private static final Logger logger = LoggerFactory.getLogger(UnitMovementTask.class);
    ...
    public UnitMovementTask(Vector2 target) {
        this.target = target;
