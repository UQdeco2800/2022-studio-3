 ...
 */
public class UnitInventoryComponent extends Component{
  private static final Logger logger = LoggerFactory.getLogger(UnitInventoryComponent.class);
  private int stone;
  private int metal;
  private int wood;

  public UnitInventoryComponent() {
    this.stone = 0;
    this.metal = 0;
    this.wood = 0;
  }
  
  public UnitInventoryComponent(int stone, int metal, int wood) {
    this.stone = stone;
    this.metal = metal;
    this.wood = wood;
  }
