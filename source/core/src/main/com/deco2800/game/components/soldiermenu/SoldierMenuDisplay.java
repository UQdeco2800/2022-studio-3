...
//         Image backgroundShopImage = new Image(texture);
...
//         backgroundTexture.setName("menu");
//         archerTexture.setName("menu");
//         swordsmanTexture.setName("menu");
//         spearmanTexture.setName("menu");
//         hopliteTexture.setName("menu");
