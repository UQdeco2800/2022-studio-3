...
public class EnemyMovementNorth extends DefaultTask implements PriorityTask {
  ...
  public EnemyMovementNorth(AtlantisTerrainFactory terrainFactory, TaskRunner owner) {
